	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'caeliora' ),
				'remove'               => esc_html__( 'Remove', 'caeliora' ),
				'default'              => esc_html__( 'Default', 'caeliora' ),
				'selectFile'           => esc_html__( 'Select File', 'caeliora' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'caeliora' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'caeliora' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'caeliora' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'caeliora' ),
			)
		);
