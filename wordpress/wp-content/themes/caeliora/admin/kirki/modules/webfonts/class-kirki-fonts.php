...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'caeliora' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'caeliora' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'caeliora' ),
			'200'       => esc_html__( 'Light 200', 'caeliora' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'caeliora' ),
			'300'       => esc_html__( 'Book 300', 'caeliora' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'caeliora' ),
			'400'       => esc_html__( 'Normal 400', 'caeliora' ),
			'regular'   => esc_html__( 'Normal 400', 'caeliora' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'caeliora' ),
			'500'       => esc_html__( 'Medium 500', 'caeliora' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'caeliora' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'caeliora' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'caeliora' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'caeliora' ),
			'700'       => esc_html__( 'Bold 700', 'caeliora' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'caeliora' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'caeliora' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'caeliora' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'caeliora' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'caeliora' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'caeliora' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'caeliora' ),
		);
	}
