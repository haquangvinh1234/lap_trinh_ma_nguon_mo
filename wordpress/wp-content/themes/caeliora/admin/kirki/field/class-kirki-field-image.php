...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'caeliora' ),
				'change'       => esc_html__( 'Change image', 'caeliora' ),
				'default'      => esc_html__( 'Default', 'caeliora' ),
				'remove'       => esc_html__( 'Remove', 'caeliora' ),
				'placeholder'  => esc_html__( 'No image selected', 'caeliora' ),
				'frame_title'  => esc_html__( 'Select image', 'caeliora' ),
				'frame_button' => esc_html__( 'Choose image', 'caeliora' ),
			)
		);
	}
